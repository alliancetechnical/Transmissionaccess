...
def tampilan_atas():
    print ("===========================================================")
    print ("#                                                         #")
    print ("#                 Transmission Access                     #")
    print ("#                ---------------------                    #")
    print ("#         created by Yithzak Syahmir, 01-01-2020          #")
    print ("# info:                                                   #")
    print ("# - Dirancang untuk Pemula                                #")
    print ("# - Dirancang untuk tujuan Belajar                        #")
    print ("# - Segala resiko tanggung sediri!!!!                     #")
    print ("# <Saya hanya tahu satu hal,yaitu saya tidak tahu apapun> #")
    print ("#                                                         #")
    print ("#                                                         #")
    print ("===========================================================")
